  ...
  <main>
    <section class="card">
      ...
      <div class="form-group">
        ...
        <select id="menu_loc" style="margin-bottom: 10px;"></select>
        <div class="inline-group">
          ...
          <div class="button-group">
            <button id="ajouter_loc" class="btn btn-success" type="button"><i class="fas fa-plus"></i> Ajouter</button>
            <button id="supprimer_loc" type="button" class="btn btn-danger"><i class="fas fa-trash"></i> Supprimer</button>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <select id="menu_sousloc" style="margin-bottom: 10px;"></select>
        <div class="inline-group">
          <div class="input-with-button">
          ...
          <div class="button-group">
            <button id="ajouter_sousloc" class="btn btn-success" type="button"><i class="fas fa-plus"></i> Ajouter</button>
            <button id="supprimer_sousloc" type="button" class="btn btn-danger"><i class="fas fa-trash"></i> Supprimer</button>
          </div>
        </div>
      </div>
    ...
    <section class="card">
      ...
      <div class="actions">
        <button id="cherche" type="button" class="btn btn-primary"><i class="fas fa-search"></i> Rechercher</button>
        <button id="Random" type="button" class="btn btn-random"><i class="fas fa-dice"></i> Jeu au hasard</button>
      </div>

      <hr class="separator">

      <div id="search-count"></div>
      <h3><i class="fas fa-list-ul"></i> Liste des jeux</h3>
      <div id="liste" class="game-list"></div>
    </section>

    <section class="card desktop-only" style="grid-column: span 2;">
        <h2><i class="fas fa-database"></i> Sauvegarde & Restauration</h2>
        <div class="actions">
            <button id="downloadBackup" type="button" class="btn btn-primary"><i class="fas fa-download"></i> Télécharger la sauvegarde</button>
            <input type="file" id="uploadBackup" accept=".zip" style="display:none;">
            <button id="uploadBtn" type="button" class="btn btn-success"><i class="fas fa-upload"></i> Restaurer une sauvegarde</button>
        </div>
    </section>
  </main>

  <footer >
    © 2025 — Où Sont Mes Jeux
  </footer>
</div>
